...
public class ClienteDTO {
    ...
    private String tipo;      // ENUM: 'A', 'B', 'C' o null = sin descuento
    ...
    public ClienteDTO(int id, String nombre, String apellido, int edad,
        ...
        this.edad = edad; this.telefono = telefono;
        this.tipo = tipo; this.email = email;
    }

    public ClienteDTO(String nombre, String apellido, int edad,
                      String telefono, String tipo, String email) {
        this.nombre = nombre; this.apellido = apellido; this.edad = edad;
        this.telefono = telefono; this.tipo = tipo; this.email = email;
    }
    ...
    @Override
    public String toString() { return id + " - " + nombre + " " + apellido; }
}