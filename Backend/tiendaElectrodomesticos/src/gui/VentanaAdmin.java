...
public class VentanaAdmin extends JFrame {
    ...
    private JPanel tabCompras() {
        modeloCompras = modelo(
                new String[] { "#", "Cliente", "Producto", "Cant.", "Sin desc.", "Descuento", "Total final" });
    ...
    private void dialogoAgregarProducto() {
        ...
        if (JOptionPane.showConfirmDialog(this,
            ...
            try {
                ...
                msg(ok ? "Producto agregado." : "Error.", ok);
                cargarProductos();
    ...
    private void eliminarProducto() {
        ...
        if (JOptionPane.showConfirmDialog(this, "¿Eliminar?", "Confirmar",
            ...
            msg(ok ? "Eliminado." : "No se puede eliminar (tiene compras).", ok);
            cargarProductos();
        }
    }
    ...
    private void dialogoAgregarCliente() {
        ...
        if (JOptionPane.showConfirmDialog(this,
            ...
            try {
                ...
                msg(ok ? "Cliente agregado." : "Error (email duplicado?).", ok);
                cargarClientes();
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "Edad debe ser número.");
            }
        }
    }
    ...
    private void dialogoAgregarUsuario() {
        ...
        if (JOptionPane.showConfirmDialog(this,
            ...
            if (pass.length() < 4) {
                JOptionPane.showMessageDialog(this, "Password mínimo 4 caracteres.");
                return;
            }
            boolean ok = coordinador.registrarUsuario(fU.getText().trim(), pass, (String) fR.getSelectedItem());
            msg(ok ? "Usuario creado." : "Username ya existe.", ok);
            cargarUsuarios();
        }
    }
    ...
    private void eliminarUsuario() {
        ...
        if (JOptionPane.showConfirmDialog(this, "¿Eliminar?", "Confirmar",
            ...
            msg(ok ? "Eliminado." : "No se puede eliminar.", ok);
            cargarUsuarios();
        }
    }
