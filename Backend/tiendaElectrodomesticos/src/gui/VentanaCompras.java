...
public class VentanaCompras extends JFrame {
    ...
    private void initUI() {
        ...
        g.gridx = 0;
        g.gridy = 1;
        panel.add(new JLabel("Cliente:"), g);
        cboClientes = new JComboBox<>();
        g.gridx = 1;
        panel.add(cboClientes, g);
        ...
        g.gridx = 1;
        panel.add(cboProductos, g);

        g.gridx = 0;
        g.gridy = 3;
        panel.add(new JLabel("Precio unitario:"), g);
        lblPrecio = new JLabel("$0");
        lblPrecio.setFont(new Font("SansSerif", Font.BOLD, 13));
        g.gridx = 1;
        panel.add(lblPrecio, g);
    ...
    private void accionComprar() {
        ...
        if (cliente == null || producto == null) {
            JOptionPane.showMessageDialog(this, "Selecciona cliente y producto.");
            return;
        }
